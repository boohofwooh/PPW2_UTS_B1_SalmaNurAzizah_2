...
Route::post('/product/delete/{product}', [ProductController::class, 'destroy'])->name('products.destroy');
Route::put('/product/updatae/{product}', [ProductController::class, 'update'])->name('products.update');
